...
class Ct_Admin_Wizard
{

    const ID = 'ct-wizard-admin';
    ...
    public function admin_enqueue_scripts($hook_suffix)
    {
        ...
        wp_enqueue_style('ct-admin-form-bs', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css', CT_WP_WIZARD_ADMIN_VERSION);

        wp_enqueue_script('ct-admin-form-bs', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js',
            array('jquery'),
            CT_WP_WIZARD_ADMIN_VERSION,
            true
        );


        wp_enqueue_style('ct-admin-form', ct_admin_url('assets/style.css'), CT_WP_WIZARD_ADMIN_VERSION);
    ...
    {
        $args['option1'] = $this->render_textarea('ct-admin-cookie', 'option1');
        $args['option2'] = $this->render_input('ct-admin-cookie', 'option2');
